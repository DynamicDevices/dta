...
DROP SCHEMA IF EXISTS `dta_test_dev` ;
CREATE SCHEMA IF NOT EXISTS `dta_test_dev` DEFAULT CHARACTER SET latin1 ;
USE `dta_test_dev` ;

-- -----------------------------------------------------
-- Table `dta_test`.`tblAddress`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dta_test_dev`.`tblAddress` ;

CREATE  TABLE IF NOT EXISTS `dta_test_dev`.`tblAddress` (
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dta_test_dev`.`tblCompany` ;

CREATE  TABLE IF NOT EXISTS `dta_test_dev`.`tblCompany` (
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dta_test_dev`.`tblEmployee` ;

CREATE  TABLE IF NOT EXISTS `dta_test_dev`.`tblEmployee` (
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dta_test_dv`.`tblTestLocation` ;

CREATE  TABLE IF NOT EXISTS `dta_test_dev`.`tblTestLocation` (
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dta_test_dv`.`tblDeviceClass` ;

CREATE  TABLE IF NOT EXISTS `dta_test_dev`.`tblDeviceClass` (
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dta_test_dev`.`tblTestList` ;

CREATE  TABLE IF NOT EXISTS `dta_test_dev`.`tblTestList` (
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dta_test_dev`.`tblTestItem` ;

CREATE  TABLE IF NOT EXISTS `dta_test_dev`.`tblTestItem` (
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dta_test_dev`.`tblDevice` ;

CREATE  TABLE IF NOT EXISTS `dta_test_dev`.`tblDevice` (
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dta_test_dev`.`tblTestListResult` ;

CREATE  TABLE IF NOT EXISTS `dta_test_dev`.`tblTestListResult` (
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dta_test_dev`.`tblTestItemResult` ;

CREATE  TABLE IF NOT EXISTS `dta_test_dev`.`tblTestItemResult` (
...
USE `dta_test`;
DROP procedure IF EXISTS `dta_test_dev`.`try_login`;
...
-- CREATE USER `vtest` IDENTIFIED BY 'test';

grant INSERT on TABLE `dta_test_dev`.`tblTestItemResult` to vtest;
grant UPDATE on TABLE `dta_test_dev`.`tblTestItemResult` to vtest;
grant SELECT on TABLE `dta_test_dev`.`tblTestItemResult` to vtest;
grant INSERT on TABLE `dta_test_dev`.`tblTestListResult` to vtest;
grant UPDATE on TABLE `dta_test_dev`.`tblTestListResult` to vtest;
grant SELECT on TABLE `dta_test_dev`.`tblTestListResult` to vtest;

-- CREATE USER `vadmin` IDENTIFIED BY 'admin';

grant ALL on TABLE `dta_test_dev`.`tblTestListResult` to vadmin;
grant ALL on TABLE `dta_test_dev`.`tblAddress` to vadmin;
grant ALL on TABLE `dta_test_dev`.`tblCompany` to vadmin;
grant ALL on TABLE `dta_test_dev`.`tblDevice` to vadmin;
grant ALL on TABLE `dta_test_dev`.`tblDeviceClass` to vadmin;
grant ALL on TABLE `dta_test_dev`.`tblEmployee` to vadmin;
grant ALL on TABLE `dta_test_dev`.`tblTestItem` to vadmin;
grant ALL on TABLE `dta_test_dev`.`tblTestItemResult` to vadmin;
grant ALL on TABLE `dta_test_dev`.`tblTestList` to vadmin;
grant ALL on TABLE `dta_test_dev`.`tblTestLocation` to vadmin;
